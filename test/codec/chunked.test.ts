...
import { computeQrModules, DEFAULT_MAX_FRAGMENT_LENGTH_CHUNKED } from '../../src/backends/qr-lt';
...
describe('Chunked Fountain Codec Core & Tagging', () => {
  ...
  it('worst-case tagged frames fit QR version 40 capacity for both backends', () => {
